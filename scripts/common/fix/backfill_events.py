...
from scripts.common.queries import get_event_details_by_id_query
...
def main() -> int:
    ...
    parser.add_argument("--max-retries", type=int, default=10, help="Maximum retries for API requests")
