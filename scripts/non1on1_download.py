        ...
        for tournament in tournaments_info:
            try:
                ...
                for event_id, event_name, is_online in events_info:
                    ...
                    if tournament_id in tournaments and event_id in [event["event_id"] for event in tournaments[tournament_id]["events"]]:
                        print(f"({tournament_name} {event_name}) already downloaded.")
                        continue
                    print([event["event_id"] for event in tournaments[tournament_id]["events"]])
                    print(f"Download {event_name}")
                ...
                if updated:
                    ...
                    write_jsonl((tournaments.values()), tournament_file_path, with_version=True)
